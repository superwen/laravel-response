...
namespace Superwen\Response;

use Illuminate\Http\JsonResponse;
use Superwen\Response\Facades\Basic;
use Superwen\Response\Facades\FormatData;
...
class Response
{
     ...
     * @return JsonResponse
     */
    public function success($data, $message = null, $code = null): JsonResponse
    {
        //格式化响应数据
     ...
     * @return JsonResponse
     */
    public function fail($code = null, $message = null): JsonResponse
    {
        $this->data = null;
     ...
     * @return JsonResponse
     */
    public function error($code = null, $message = null, $error = null, $debug = []): JsonResponse
    {
        $this->data = null;
     ...
     * @return JsonResponse
     */
    public function created($code = null, $message = null, $data = []): JsonResponse
    {
        //格式化响应数据
        $formatData = FormatData::format($data);
     ...
     * @return JsonResponse
     */
    public function unauthorized($code = null, $message = null): JsonResponse
    {
        $this->data = null;
     ...
     * @return JsonResponse
     */
    public function forbidden($code = null, $message = null): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    public function notFound($code = null, $message = null): JsonResponse
    {
        $this->data = null;
     ...
     * @return JsonResponse
     */
    public function validateFail($code = null, $message = null, $error = null, $debug = []): JsonResponse
    {
        $this->data = null;
